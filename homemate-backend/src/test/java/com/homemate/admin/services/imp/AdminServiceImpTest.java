...
class AdminServiceImpTest {
    ...
    void testGetUsersWithFiltersReturnsPaginatedUsers() {
    ...
    void testGetUsersWhenNoUsersReturnsEmptyList() {
    ...
    void testGetUsersWithLargeDatasetCalculatesTotalPagesCorrectly() {
    ...
    void testGetTaskersWithFiltersReturnsPaginatedTaskers() {
    ...
    void testGetTaskersWithPage2CalculatesOffsetCorrectly() {
    ...
    void testSuspendUserUserNotFound() {
    ...
    void testSuspendUserUpdateFails() {
        User before = createMockUsers(1).get(0);
        before.setUserId(3L);
        before.setSuspended(false);
    ...
    void testSuspendTaskerNotFound() {
    ...
    void testSuspendTaskerUpdateFails() {
        Tasker before = createMockTaskers(1).get(0);
    ...
    void testReactiveUserUpdateFails() {
        User before = createMockUsers(1).get(0);
        before.setUserId(8L);
        before.setSuspended(true);
    ...
    void testReactiveTaskerNotFound() {
    ...
    void testReactiveTaskerUpdateFails() {
        Tasker before = createMockTaskers(1).get(0);
