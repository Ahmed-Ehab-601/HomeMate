...
-- ======================================================
-- Insert test users with various demographics
-- ======================================================
...
VALUES 
    ...
    (3, 'Bob', 'Wilson', 'bobwilson', 'password789', 'bob@test.com', '1985-08-20 00:00:00', 'M', '5555555555', false, true),
    (4, 'Alice', 'Johnson', 'alicej', 'password101', 'alice@test.com', '1995-03-10 00:00:00', 'F', '4444444444', false, false),
    (5, 'Charlie', 'Brown', 'charlieb', 'password202', 'charlie@test.com', '1988-12-25 00:00:00', 'M', '3333333333', false, false),
    (6, 'Diana', 'Miller', 'dianam', 'password303', 'diana@test.com', '1990-01-01 00:00:00', 'F', '2222222222', false, true);
...
VALUES 
    (1, 'Mike', 'Johnson', 'mikej', 'pass123', 'mike@test.com', '1985-03-10 00:00:00', '1111111111', 'M', 'available', 4.5, 25.50, 'Experienced plumber', 1, 500.00, 20.00, 'Cairo', false),
    (2, 'Sarah', 'Williams', 'sarahw', 'pass456', 'sarah@test.com', '1990-07-22 00:00:00', '2222222222', 'F', 'available', 4.8, 30.00, 'Professional electrician', 2, 800.00, 30.00, 'Alexandria', false),
    (3, 'Tom', 'Davis', 'tomd', 'pass789', 'tom@test.com', '1988-11-05 00:00:00', '3333333333', 'M', 'unavailable', 3.5, 20.00, 'Expert cleaner', 3, 300.00, 15.00, 'Giza', true),
    (4, 'Emma', 'Taylor', 'emmat', 'pass101', 'emma@test.com', '1992-06-18 00:00:00', '4444444444', 'F', 'available', 4.2, 28.00, 'Skilled painter', 4, 600.00, 25.00, 'Cairo', false),
    (5, 'James', 'Anderson', 'jamesa', 'pass202', 'james@test.com', '1987-09-30 00:00:00', '5555555555', 'M', 'available', 4.0, 22.00, 'Plumbing specialist', 1, 400.00, 18.00, 'Cairo', false);
...
VALUES 
    ...
    (6, '2024-01-06 11:00:00', 4.0, 4, 4, 4, '2024-01-06 15:00:00', 112.00, 'Done', 4, 'Paint living room'),
    (7, '2024-01-07 09:00:00', 0, 5, 5, 1, NULL, 0, 'Rejected', 5, 'Pipe replacement'),
    (8, '2024-01-08 13:00:00', 2.0, 1, 1, 1, '2024-01-08 15:00:00', 51.00, 'Done', 1, 'Fix bathroom faucet'),
    (9, '2024-01-09 10:00:00', 0, 2, 2, 2, NULL, 0, 'Suspended', 2, 'Rewire bedroom'),
    (10, '2024-01-10 08:00:00', 1.5, 4, 1, 1, '2024-01-10 09:30:00', 38.25, 'Done', 4, 'Unclog drain');
