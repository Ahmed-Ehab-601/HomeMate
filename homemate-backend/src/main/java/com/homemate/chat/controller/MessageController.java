...
public class MessageController {
    ...
    public ResponseEntity<MessageDto> userMessage(@PathVariable Long chatID,
    ...
    public ResponseEntity<MessageDto> taskerMessage(@PathVariable Long chatID,
    ...
    @PreAuthorize("hasRole('TASKER')")
    public ResponseEntity<Void> markMessagesAsRead(@PathVariable Long chatID, @AuthenticationPrincipal AppUserDetails userDetails) {
        try {
    ...
    @PreAuthorize("hasRole('USER')")
    public ResponseEntity<Boolean> calculate(@PathVariable Long userID,
                @AuthenticationPrincipal AppUserDetails userDetails) {
        try {
    ...
    @PreAuthorize("hasRole('TASKER')")
    public ResponseEntity<Boolean> calculateT(@PathVariable Long taskerID,
                  @AuthenticationPrincipal AppUserDetails userDetails) {
