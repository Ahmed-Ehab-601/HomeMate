 ...
 ('Tom', 'Anderson', 'tanderson', '1234', 'tom.a@tasker.com', '1985-03-20', '+1-555-1001', 'M', NULL, 'available', 4.8, 35.00, 'Experienced cleaner with 10 years in the business.', 1, 15400.00, 440.00, 'New York'),
 ('Lisa', 'Thompson', 'lthompson', '1234', 'lisa.t@tasker.com', '1982-07-14', '+1-555-1002', 'F', NULL, 'available', 4.9, 55.00, 'Licensed plumber with expertise in residential repairs.', 1, 28600.00, 520.00, 'Los Angeles'),
 ('Mark', 'White', 'mwhite', '1234', 'mark.w@tasker.com', '1988-11-02', '+1-555-1003', 'M', NULL, 'available', 4.7, 60.00, 'Certified electrician, safety is my priority.', 1, 19800.00, 330.00, 'Chicago'),
 ('Karen', 'Harris', 'kharris', '1234', 'karen.h@tasker.com', '1990-05-28', '+1-555-1004', 'F', NULL, 'available', 4.6, 30.00, 'Passionate gardener with a green thumb.', 1, 9600.00, 320.00, 'Houston'),
 ('James', 'Clark', 'jclark', '1234', 'james.c@tasker.com', '1986-09-17', '+1-555-1005', 'M', NULL, 'available', 4.9, 45.00, 'Professional painter with attention to detail.', 1, 22500.00, 500.00, 'Phoenix'),
 ('Nancy', 'Lewis', 'nlewis', '1234', 'nancy.l@tasker.com', '1984-12-08', '+1-555-1006', 'F', NULL, 'unavailable', 4.5, 50.00, 'Skilled carpenter, custom work specialist.', 1, 17000.00, 340.00, 'Philadelphia'),
 ('Steve', 'Walker', 'swalker', '1234', 'steve.w@tasker.com', '1992-02-22', '+1-555-1007', 'M', NULL, 'available', 4.4, 40.00, 'Reliable moving services, careful with your items.', 1, 12800.00, 320.00, 'San Antonio'),
 ('Patricia', 'Hall', 'phall', '1234', 'patricia.h@tasker.com', '1987-06-30', '+1-555-1008', 'F', NULL, 'available', 4.8, 65.00, 'HVAC expert with 15 years experience.', 1, 26000.00, 400.00, 'San Diego'),
 ('Daniel', 'Allen', 'dallen', '1234', 'daniel.a@tasker.com', '1995-08-11', '+1-555-1009', 'M', NULL, 'available', 4.7, 25.00, 'Animal lover providing quality pet care.', 1, 7500.00, 300.00, 'Dallas'),
 ('Maria', 'Young', 'myoung', '1234', 'maria.y@tasker.com', '1989-10-19', '+1-555-1010', 'F', NULL, 'available', 4.9, 40.00, 'Experienced tutor in math and science.', 1, 16000.00, 400.00, 'New York'),
 ('Oliver', 'King', 'oking', '1234', 'oliver.k@tasker.com', '1991-04-12', '+1-555-1011', 'M', NULL, 'available', 4.6, 45.00, 'Home cleaning expert.', 1, 14500.00, 380.00, 'New York'),
 ('Emily', 'Green', 'egreen', '1234', 'emily.g@tasker.com', '1993-06-22', '+1-555-1012', 'F', NULL, 'available', 4.8, 60.00, 'Licensed plumber with 6 years of experience.', 1, 18200.00, 410.00, 'Los Angeles'),
 ('Henry', 'Moore', 'hmoore', '1234', 'henry.m@tasker.com', '1987-02-10', '+1-555-1013', 'M', NULL, 'available', 4.5, 58.00, 'Electrical expert.', 1, 20000.00, 440.00, 'Chicago'),
 ('Sophia', 'Baker', 'sbaker', '1234', 'sophia.b@tasker.com', '1994-03-18', '+1-555-1014', 'F', NULL, 'unavailable', 4.7, 32.00, 'Gardening and lawn care specialist.', 1, 10800.00, 300.00, 'Houston'),
 ('Ethan', 'Reed', 'ereed', '1234', 'ethan.r@tasker.com', '1990-07-09', '+1-555-1015', 'M', NULL, 'available', 4.9, 48.00, 'Professional painter.', 1, 24000.00, 500.00, 'Phoenix'),
 ('Grace', 'Price', 'gprice', '1234', 'grace.p@tasker.com', '1985-01-27', '+1-555-1016', 'F', NULL, 'available', 4.6, 52.00, 'Experienced carpenter.', 1, 19400.00, 460.00, 'Philadelphia'),
 ('Logan', 'Wright', 'lwright', '1234', 'logan.w@tasker.com', '1991-10-13', '+1-555-1017', 'M', NULL, 'unavailable', 4.4, 42.00, 'Moving & delivery specialist.', 1, 11000.00, 270.00, 'San Antonio'),
 ('Victoria', 'Brooks', 'vbrooks', '1234', 'victoria.b@tasker.com', '1989-11-07', '+1-555-1018', 'F', NULL, 'available', 4.8, 70.00, 'HVAC engineer.', 8, 28000.00, 420.00, 'San Diego'),
 ('Matthew', 'Evans', 'mevans', '1234', 'matt.e@tasker.com', '1994-05-16', '+1-555-1019', 'M', NULL, 'available', 4.9, 30.00, 'Pet care expert.', 9, 13500.00, 380.00, 'Dallas'),
 ('Hannah', 'Rivera', 'hrivera', '1234', 'hannah.r@tasker.com', '1992-08-23', '+1-555-1020', 'F', NULL, 'available', 4.7, 45.00, 'Academic tutor.', 10, 17500.00, 390.00, 'New York'),

 ('Noah', 'Scott', 'nscott', '1234', 'noah.s@tasker.com', '1990-01-11', '+1-555-1021', 'M', NULL, 'available', 4.6, 35.00, 'Chef and meal prep expert.', 11, 12000.00, 330.00, 'Los Angeles'),
 ('Ava', 'Cooper', 'acooper', '1234', 'ava.c@tasker.com', '1995-09-30', '+1-555-1022', 'F', NULL, 'available', 4.8, 55.00, 'IT support specialist.', 12, 21000.00, 450.00, 'Chicago'),
 ('Liam', 'Ward', 'lward', '1234', 'liam.w@tasker.com', '1988-12-03', '+1-555-1023', 'M', NULL, 'available', 4.5, 25.00, 'Car washing and detailing.', 13, 8000.00, 260.00, 'Houston'),
 ('Chloe', 'Cruz', 'ccruz', '1234', 'chloe.c@tasker.com', '1991-06-08', '+1-555-1024', 'F', NULL, 'available', 4.9, 40.00, 'Home repair handyman.', 14, 16000.00, 340.00, 'Phoenix'),
 ('Daniel', 'Bell', 'dbell', '1234', 'daniel.b@tasker.com', '1986-02-19', '+1-555-1025', 'M', NULL, 'available', 4.7, 65.00, 'Fitness trainer.', 15, 30000.00, 470.00, 'Philadelphia'),
 ('Ella', 'Murphy', 'emurphy', '1234', 'ella.m@tasker.com', '1994-07-14', '+1-555-1026', 'F', NULL, 'available', 4.6, 30.00, 'Babysitter with 5 years experience.', 16, 9000.00, 250.00, 'San Antonio'),
 ('Mason', 'Cook', 'mcook', '1234', 'mason.c@tasker.com', '1993-09-25', '+1-555-1027', 'M', NULL, 'unavailable', 4.8, 55.00, 'Elder care specialist.', 17, 22000.00, 390.00, 'San Diego'),
 ('Zoe', 'Morgan', 'zmorgan', '1234', 'zoe.m@tasker.com', '1992-04-04', '+1-555-1028', 'F', NULL, 'available', 4.9, 75.00, 'Interior designer.', 18, 31000.00, 410.00, 'Dallas'),
 ('Jack', 'Lee', 'jlee', '1234', 'jack.l@tasker.com', '1991-03-12', '+1-555-1029', 'M', NULL, 'available', 4.6, 80.00, 'Event photographer.', 19, 26000.00, 390.00, 'New York'),
 ('Layla', 'Turner', 'lturner', '1234', 'layla.t@tasker.com', '1990-11-29', '+1-555-1030', 'F', NULL, 'available', 4.7, 55.00, 'Home security installer.', 20, 17800.00, 350.00, 'Los Angeles'),
 ('Aaron', 'Mitchell', 'amitchell', '1234', 'aaron.m@tasker.com', '1987-05-12', '+1-555-1031', 'M', NULL, 'available', 4.5, 33.00, 'Cleaner.', 1, 11200.00, 300.00, 'Houston'),
 ('Natalie', 'Ross', 'nross', '1234', 'natalie.r@tasker.com', '1993-10-01', '+1-555-1032', 'F', NULL, 'available', 4.9, 58.00, 'Plumber.', 2, 21000.00, 430.00, 'Chicago'),
 ('Wyatt', 'Perry', 'wperry', '1234', 'wyatt.p@tasker.com', '1990-06-22', '+1-555-1033', 'M', NULL, 'available', 4.7, 65.00, 'Electrician.', 3, 24000.00, 450.00, 'Los Angeles'),
 ('Bella', 'Foster', 'bfoster', '1234', 'bella.f@tasker.com', '1991-01-18', '+1-555-1034', 'F', NULL, 'available', 4.8, 35.00, 'Gardener.', 4, 13200.00, 280.00, 'Phoenix'),
 ('Owen', 'Howard', 'ohoward', '1234', 'owen.h@tasker.com', '1989-03-03', '+1-555-1035', 'M', NULL, 'available', 4.9, 48.00, 'Painter.', 5, 20000.00, 420.00, 'New York'),
 ('Aria', 'Ward', 'award', '1234', 'aria.w@tasker.com', '1992-02-11', '+1-555-1036', 'F', NULL, 'available', 4.8, 52.00, 'Carpenter.', 6, 18500.00, 380.00, 'Philadelphia'),
 ('Carter', 'Fleming', 'cfleming', '1234', 'carter.f@tasker.com', '1994-09-27', '+1-555-1037', 'M', NULL, 'available', 4.6, 44.00, 'Mover.', 7, 12500.00, 310.00, 'Houston'),
 ('Hailey', 'Summers', 'hsummers', '1234', 'hailey.s@tasker.com', '1993-07-05', '+1-555-1038', 'F', NULL, 'available', 4.9, 72.00, 'HVAC technician.', 8, 28000.00, 430.00, 'Chicago'),
 ('Gabriel', 'Bryant', 'gbryant', '1234', 'gabriel.b@tasker.com', '1991-12-14', '+1-555-1039', 'M', NULL, 'available', 4.7, 26.00, 'Pet care expert.', 9, 9800.00, 300.00, 'Dallas'),
 ('Stella', 'Cole', 'scole', '1234', 'stella.c@tasker.com', '1990-04-21', '+1-555-1040', 'F', NULL, 'available', 4.8, 48.00, 'Tutor.', 10, 15000.00, 350.00, 'New York');
 -- ======================================================
 -- POPULATE CHATS
 -- ======================================================
